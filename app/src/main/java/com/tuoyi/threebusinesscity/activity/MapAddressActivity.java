...
import com.tuoyi.threebusinesscity.adapter.SearchResultAdapter;
import com.tuoyi.threebusinesscity.util.JumpUtil;
import com.tuoyi.threebusinesscity.util.SegmentedGroup;

import java.util.ArrayList;
import java.util.List;

/* 企业设置 - 地图选择地点 */
public class MapAddressActivity extends AppCompatActivity implements LocationSource,
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(MapAddressActivity.this);
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    ...
                    Inputtips inputTips = new Inputtips(MapAddressActivity.this, inputquery);
...
//        Log.i("MY", "onLocationChanged");
        if (mListener != null && amapLocation != null) {
            if (amapLocation != null
                ...
                mListener.onLocationChanged(amapLocation);         //显示定位蓝点
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(MapAddressActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(MapAddressActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(MapAddressActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
    ...
    AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
           // if (position != searchResultAdapter.getSelectedPosition()) {
                ...
                Log.e(TAG, "onItemClick地址县: " + poiItem.getAdName());
//                ToastUtil.show(MapAddressActivity.this,poiItem.getCityName() + poiItem.getAdName() + poiItem.getSnippet() + poiItem.getTitle());
                String address = "";
                ...
                bundle.putString("县", poiItem.getAdName());
                JumpUtil.newInstance().finishRightTrans(MapAddressActivity.this, bundle, 003);
            }
       //}
    };
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(MapAddressActivity.this, "erroCode " + rCode, Toast.LENGTH_SHORT).show();
            }
        }
    };
