...
public class MenuAdapter extends BaseAdapter {
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        if (arg0 == selectItem) {
            ...
            holder.tv_name.setBackgroundColor(context.getResources().getColor(R.color.whiteColor));
            holder.tv_name.setTextColor(context.getResources().getColor(R.color.blackColor));
        }
